...
- **หน้า Design (IT-Admin, ปุ่มไอคอนพู่กันในเมนู)** — หน้าแรกเป็น All Campaign กดการ์ดแคมเปญเพื่อแก้รูป (ปุ่ม Another Campaign กลับมาเลือกแคมเปญอื่น หรือกดปุ่ม Design บนการ์ดในหน้าแรกก็ได้) ใส่รูปและรายละเอียดที่แสดงบนหน้าของแคมเปญนั้น บันทึกอัตโนมัติทุกครั้งที่แก้ (เก็บใน `campaigns.design_json`) รูปอัปโหลดเก็บที่ `uploads/design/` และเปิดดูได้สาธารณะ

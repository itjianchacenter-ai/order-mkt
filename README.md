...
- **หน้า Design (IT-Admin, ปุ่มไอคอนพู่กันในเมนู)** — ใส่รูปและรายละเอียดที่แสดงบนหน้าแรกของแต่ละแคมเปญ บันทึกอัตโนมัติทุกครั้งที่แก้ (เก็บใน `campaigns.design_json`) รูปอัปโหลดเก็บที่ `uploads/design/` และเปิดดูได้สาธารณะ

...
(async () => {
  ...
  try {
    ...
    r = await call('customer', 'POST', '/api/orders', { store_id: storeId, phone: '0812345678', pickup_date: '2026-09-28', pickup_time: '13:00-15:00 น.', lines: [{ set_id: A, quantity: 1 }] }); check('order with a date outside the campaign list rejected', r.status === 400 && r.json.field === 'pickup_date', r.json);
